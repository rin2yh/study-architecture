...
import { redirectIfAuthenticated, SESSION_COOKIE } from "@/shared/lib/session";
import { createSession } from "api/member";
import { redirect } from "react-router";

vi.mock("@/shared/lib/session", async (importActual) => {
  const actual = await importActual<typeof import("@/shared/lib/session")>();
