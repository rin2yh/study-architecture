...
- Status: Accepted
- Date: 2026-06-24
- Relates to: ADR-[[202606240522]] (Step 3 DB 分割), ADR-[[202606241420]] (メトリクス取り込み), ADR-[[202606250159]] (非同期イベントのトレース伝播), ADR-[[202606250141]] (マスキング)
...
非同期イベントの伝播は ADR-[[202606250159]]、メトリクス取り込みは ADR-[[202606241420]]、マスキングは
